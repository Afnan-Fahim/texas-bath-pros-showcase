...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Meta Pixel (ID 1062683162839921) — hard-installed in <head> of the
            server-rendered HTML so it runs on first paint on every page,
            including /quiz. No consent gate. Only pixel on the site. */}
        <script
          id="meta-pixel"

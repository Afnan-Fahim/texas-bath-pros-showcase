    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center">
      ...
      >
        <img
          ...
          className="relative z-20 h-36 w-auto max-w-[94vw] translate-y-1 sm:h-[10.5rem] sm:max-w-none sm:translate-y-2 md:h-[10.5rem] md:translate-y-2"
          width={400}
          height={80}
          fetchPriority="high"
        />
      ...
      <main ref={stageRef} className="flex w-full flex-1 items-center justify-center px-4 sm:px-6 py-3 sm:py-5 md:py-4 relative">

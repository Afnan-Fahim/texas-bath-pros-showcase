    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          slogan: "Trusted Shower Experts",
          description:
            "Family-owned, A+ BBB-accredited bathroom remodeling company based in San Antonio, Texas. Specializing in premium acrylic and Onyx shower systems, tub-to-shower conversions, and walk-in showers, professionally installed. Free estimates, $0 down financing, and flexible payment options.",
          priceRange: "$$",
          areaServed: [
            "San Antonio, TX",
            "Terrell Hills, TX",
